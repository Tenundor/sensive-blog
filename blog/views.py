...
def serialize_post_optimised(post, serialized_comments=None, is_teaser=True):
    serialized_post = {
        "title": post.title,
        "author": post.author.username,
...
def serialize_tag_optimised(tag):
    return {
        "title": tag.title,
...
def index(request):
    ...
    context = {
        ...
        "popular_tags": [serialize_tag_optimised(tag) for tag in most_popular_tags],
    }
...
def post_detail(request, slug):
    ...
    serialized_post = serialize_post_optimised(post, serialized_comments, is_teaser=False)
